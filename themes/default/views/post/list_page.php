...
<div class="global clear">
  ...
  <div class="mainBox">
    <div class="loc clear">
      <div class="position"> <span>您的位置：</span> <a href="<?php echo Yii::app()->homeUrl?>">首页</a> <em></em><?php echo $young91CatalogShow->catalog_name?> </div>
    </div>
	<div class="postWrap">
	<div class="h head">
        <h1 class="title"><?php echo $young91CatalogShow['catalog_name']?></h1>
      </div>
    <div class="clear cdata">
     <?php echo $young91CatalogShow['content']?>
    </div>
	</div>
  </div>
</div>

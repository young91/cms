...
<div class="mainbody">
  ...
  <div class="inst_btn_area">
    ...
    <p class="env_success">恭喜！您的服务器配置完全符合young91的安装要求。 </p>
    <?php elseif(($requireResult < 0 || $writeableResult <0) ): ?>
    <p class="tips">您的服务器配置符合young91的最低要求。如果您需要使用特定的功能，请关注以上警告部分。 </p>
    <?php else: ?>
    <p class="tips error"> 您的服务器配置未能满足young91的安装要求。 </p>
    <?php endif; ?>

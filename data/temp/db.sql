...
(1, '首页banner', 'index_banner', 'http://www.ecoutpost.com', '', '', '', '', 0, 1379520000, 1546272000, 'uploads/201309/523a2c04a37a1.jpg', 8, 'Y', 1379544068),
...
('base', 'site_domain', 'http://www.ecoutpost.com', ''),
('base', 'admin_email', 'abc@qq.com', ''),
('base', 'site_icp', '浙ICP备13017320号-1', ''),
('base', 'site_closed_summary', '系统维护中，请稍候......', ''),
('base', 'site_stats', '第三方统计代码', ''),
...
('base', 'site_copyright', 'Copyright ? 2011-2012', ''),
...
--
-- Dumping data for table `#@__link`
--

INSERT INTO `#@__link` (`id`, `site_name`, `site_url`, `sort_order`, `click_count`, `link_type`, `attach_file`, `status_is`, `create_time`) VALUES
(1, 'php源码网', 'http://www.osphp.com.cn', 0, 0, 'txt', '', 'Y', 1369829454),
(2, '八哥CMS', 'http://www.ecoutpost.com', 0, 0, 'image', 'uploads/201306/51c06dcdec592.png', 'Y', 1369829469),
(3, '八哥出品', 'http://www.qbage.com', 0, 0, 'txt', '', 'Y', 1369829482),
(4, '测试', 'http://www.bagesoft.cn', 0, 0, 'image', 'uploads/201306/51c06de6bd737.png', 'Y', 1371565542);
...
(1, '关于我们', '', 'about', '', '', 'young91是一款基于php5+mysql5开发的多功能开源的网站内容管理系统。使用高性能的PHP5的web应用程序开发框架YII构建，具有操作简单、稳定、安全、高效、跨平台等特点。采用MVC设计模式，模板定制方便灵活，内置小挂工具，方便制作各类功能和效果，young91可用于企业建站、个人博客、资讯门户、图片站等各类型站点', '<p>\r\n	young91是一款基于php5+mysql5开发的多功能开源的网站内容管理系统。使用高性能的PHP5的web应用程序开发框架YII构建，具有操作简单、稳定、安全、高效、跨平台等特点。采用MVC设计模式，模板定制方便灵活，内置小挂工具，方便制作各类功能和效果，young91可用于企业建站、个人博客、资讯门户、图片站等各类型站点。<br />\r\n<br />\r\n特点：<br />\r\n<br />\r\n1.开源免费<br />\r\n无论是个人还是企业展示型网站均可用本系统来完成<br />\r\n<br />\r\n2.数据调用方便快捷<br />\r\n自主研发的数据调用模块，能快速调用各类型数据，方便建站<br />\r\n<br />\r\n3.应用范围广<br />\r\n这套系统不是企业网站管理系统，也不是博客程序，更不是专业的图片管理系统，但它却具备大部分企业站、博客站、图片站的功能<br />\r\n<br />\r\n4.安全高性能<br />\r\n基于高性能的PHP5的web应用程序开发框架YII构建具有稳定、安全、高效、跨平台等特点<br />\r\n<br />\r\n5.URL自定义<br />\r\n系统支持自定义伪静态显示方式，良好的支持搜索引擎SEO。个性化设置每个栏目、内容的标题标签、描述标签、关键词标签<br />\r\n<br />\r\n6.自定义数据模型<br />\r\n系统可自定义数据模型满足各种表示形式和字段需求<br />\r\n<br />\r\n7.完善的后台权限控制<br />\r\n特有的管理员权限管理机制，可以灵活设置管理员的栏目管理权限、网站信息的添加、修改、删除权限等<br />\r\n<br />\r\n<br />\r\n系统运行环境：<br />\r\n数据库： mysql5+<br />\r\nPHP版本：php5.2.+<br />\r\n服务器：linux,unix,freebsd等<br />\r\n<br />\r\n官方网址：http://www.ecoutpost.com<br />\r\n下载地址：http://www.ecoutpost.com/download/young91<br />\r\n<br />\r\n演示地址：http://demo.young91.com<br />\r\n后台地址：http://demo.young91.com/admini<br />\r\n用户：young91<br />\r\n密码：young91\r\n</p>\r\n<p>\r\n	<br />\r\n</p>', '', '', '', '', 'uploads/201309/logo.jpg', 'uploads/201309/logo.jpg', 0, 0, '', 1322999570),
(2, '联系我们', '', 'contact', '', '', '', '<p>\r\n	QQ:5565907\r\n</p>\r\n<p>\r\n	QQ群：139869141\r\n</p>\r\n<p>\r\n	young91官方网站：<a href="http://www.ecoutpost.com" target="_blank">http://www.ecoutpost.com</a>\r\n</p>\r\n<p>\r\n	八哥软件官方网站：<a href="http://www.bagesoft.cn" target="_blank">http://www.bagesoft.cn</a>\r\n</p>', '', '', '', '', '', '', 0, 0, '', 1322999588),
...
(1, 0, 0, '', '八哥软件', '5565907@qq.com', '', 'young91是一款基于php5+mysql5开发的多功能开源的网站内容管理系统。使用高性能的PHP5的web应用程序开发框架YII构建，具有操作简单、稳定、安全、高效、跨平台等特点。采用MVC设计模式，模板定制方便灵活，内置小挂工具，方便制作各类功能和效果，young91可用于企业建站、个人博客、资讯门户、图片站等各类型站点。', '', 'N', '如果您需要购买商业程序、项目外包订制、交流合作的，欢迎使用以下方式和我们联系\r\nhttp://www.ecoutpost.com\r\nhttp://www.bagesoft.cn', 'Y', 1379546643);
